...
class Resize:
   ...
   def setup(self):
      ...
      self.layout = [[sg.Text("リサイズを行う動画を選択してください")],
                     ...
                     [sg.Listbox(size_list, size=(15, len(size_list)), key='_resize_')],
   ...
   def main(self):
      ...
      while True:
         ...
         if event == "resize":
            ...
            frame_process.FrameProcess().resize(values["movie"], values["_resize_"][0], values["file_name"], self.window["bar"])
